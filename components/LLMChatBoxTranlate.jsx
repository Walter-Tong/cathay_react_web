...
function LLMChatBoxTranlate() {
    const system = 'You will be given a request to flight attendant, the message could be in any language, translate and rephase the request to english and a smooth and a easy to read tone'
