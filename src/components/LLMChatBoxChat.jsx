...
function LLMChatBoxChat({ previousMessages, setPreviousMessages }) {
  ...
  const baseSystem =
    'You are a chatbot that provide information to passager, you will given a set of frquency ask question. Please use them to ask to provide answer to passenger question'
